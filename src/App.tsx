      ...
      <SecondSection id="secondSection">
        <FlexBoxItem>
          ...
          <Box>
            ...
            <FlexboxText>
              ...
              אישית שתפחית את התשלומים החודשיים ותשפר את תנאי ההלוואות שלכם. נעשה יחד את הצעד הראשון לעבר חופש כלכלי וביטחון פיננסי!
            </FlexboxText>
          </Box>
        </FlexBoxItem>
        <FlexBoxItem>
        ...
        <FlexBoxItem>
          ...
          <FlexboxText>
            ...
            <br />
            אני אעשה הכל כדי שתזכו בתנאים הטובים ביותר ובתהליך חלק ונוח. ונתחיל במסע להגשמת החלום שלכם!
          </FlexboxText>
        </FlexBoxItem>
      </SecondSection>
      <ThirdSection>
